...
const title = 'Servicios | GuestsValencia — Suite PropTech & gestión 7★';
const description = 'Comercialización, Revenue Management, Operativa, Atención 24/7, Tecnología PropTech, Asesoría legal y Experiencias.';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: '/servicios',
    images: [{ url: ogImage, width: 1200, height: 630, alt: 'GuestsValencia Servicios' }],
  },
  twitter: {
...
const services = [
  { title: 'Comercialización y marketing', bullets: [
  ...
  { title: 'Revenue Management', bullets: [
  ...
  { title: 'Operativa y calidad', bullets: [
...
export default function Page() {
  const waMessage = 'Hola, quiero una propuesta de servicios para mi alojamiento.';
  return (
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="rounded-2xl border p-8 bg-white">
          ...
          <div className="mt-4 flex gap-3">
            ...
            <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WA_PHONE || '34600000000'}?text=${encodeURIComponent(waMessage)}`} className="rounded-2xl px-5 py-3 border">WhatsApp</a>
          </div>
        </div>
      </section>
